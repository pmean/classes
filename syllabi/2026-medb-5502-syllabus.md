---
title: "Syllabus: Applied Biostatistics II, MEDB 5502, 2026 Spring Semester"
---
...
Clinical research carries an increasingly important role as it contributes to critical issues facing our health care system. In order for clinical research to address these issues, appropriate methods for data processing and analysis must be conducted. The Department of Biomedical and Health Informatics Biostatistics sequence has been designed to provide students with the applied knowledge and skills they will need in order to contribute to the creation, analysis, and understanding of data generated by clinical and patient care studies. 
...
There is a grading rubric for each programming assignment. Your work is due on the specified date. Short extensions of the deadline are possible, but please follow the [policy on extensions and rework][extensions]. Do not ask for repeated extensions. We need to keep the class on the same time schedule for a variety of reasons. If you find yourself continually falling behind on the assignments, you must set up a meeting to discuss this.

[extensions]: https://github.com/pmean/classes/blob/master/general/src/policy-on-extensions-and-rework.md
...
There may be minor changes and/or additions to this list.
...
You must use a UMKC e-mail account for correspondence in this class.  The instructor will not be responsible for the receipt of e-mails that are sent from locations other than those ending with “umkc.edu”.
