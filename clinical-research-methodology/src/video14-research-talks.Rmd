---
title: "Video 13 - Talking about your research"
author: "Steve Simon"
output: 
...
The worst sin you can commit in scientific presentations is going over your alloted time limit. The audience will hate you for it, because they have a busy conference and don't want your talk to interfere with their schedule.
...
If you end up finishing a bit early, the other speakers will love you for it. Never feel bad about failing to fill out every alloted minute you have been given.
...
I don't wnat to list advantages and disadvantages to these alternatives. In general, they all have their own quirks, but they are all still professional grade quality products.
...
"Don't read your presentaiton to your audience. It is safe to assume that they can read unless you are working with small children. Even if you were working with small children, you are probably better off showing images than a lot of text."

This example is a trap I have fallen into. When I am nervous about a particular topic, I tend to put all the words I plan to say directly on the slide. That way I won't forget someting important. But you can and should use speaker notes.
...
Peter Norvig has a satirical slide show up about Lincoln's Gettyburg address. This is one of the most famous speeches in U.S. History. I want to read it to you right now, because it is so well done.
...
The first slide reads "Agenda" with bullet points

Met on the battlefied (great)

Dedicate portion of field - fitting!

Unfinished work (great tasks.)

Notice how the bullets literally suck the life out of Lincoln's inspirational words?
