---
title: "Video09a - Validity and reliability"
author: "Steve Simon"
output: 
...
### 9a, Measurements that warrant closer scrutiny
...
### 9a, Kuder-Richardson 20

* Only for composite measures with binary items
+ $\frac{1}{I-1}\big(1-\frac{\Sigma_ip_iq_i}{S^2}\big)$
...
### 9a, Face validity and content validity
...
### 9a, Validity of diagnostic tests
+ Sensitivity
