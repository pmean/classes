...
-   Tibbles created by this program
    -   art0: Original data from art-malpresentations.csv
    -   art1: manual calculation of key statistics
    -   vax0: Original data from vaccine-willingness.csv
    -   vax1: Manual calculation of key statistics
...
The overall odds ratio is 1.5 with a small p-value and a confidence interval that excludes 1. This indicates a statistically significant increase in the risk of malpresentation associated with art.
...
Finally, the forest function uses [grid][ref-grid-nodate], a specialized R plotting facility. This means that you cannot easily add a title to this graph.

There is a package, [forestploter][ref-forestploter-nodate], that will produce a forest plot using the ggplot2 approach, but it is rather complex.
...
funnel(m1)
title("Steve Simon, 2025-03-18, CC0")
```
