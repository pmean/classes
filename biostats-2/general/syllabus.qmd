...
-   Correlation:
    -   Define correlation
    -   Determine when to use correlation analysis
    -   Identify and run all assumptions and tests for the Pearson Correlation analysis
    -   Define the calculated statistics for the Pearson Correlation analysis
    -   Explain the range of values of the correlation coefficient
    -   Interpret a correlation coefficient
    -   Explain the limitations of a correlation analysis
    -   Explain why correlation is not causation
    -   Write the Null and Alternative hypotheses for a correlation analysis
    -   Set up data for a correlation analysis in SPSS
    -   Define Monotonic
    -   Write the implications of correlation analysis results when outliersare in a data set
    -   Define bivariate normality
    -   Test for bivariate normality
    -   Run a correlation analysis in SPSS for a Pearson Correlation analysis
    -   Interpret the output of a Pearson Correlation analysis
    -   Report the effect size for a Pearson correlation analysis
    -   Explain the relationship between sample size and correlation significance
    -   Correctly write a summary of a Pearson Correlation analysis
-   Regression Analysis:
    -   Define Simple Linear Regression in terms of usage
    -   Define Predictor Variable and Outcome Variable
    -   Define Line of Best Fit, Slope and Y intercept
    -   Define residuals
    ...
    -   Define and Explain Homoscedasticity of Residuals
    -   Define and know the processes to test each of the assumptions that must be met for a Linear Regression Analysis to be run
    -   Write the Null and Alternative Hypothesis for a Linear Regression Analysis
    -   Define Autocorrelation
    -   Define and know how to interpret the Durbin-Watson Test
    -   Show the SPSS process for running a Linear Regression Analysis
    -   Run a Linear Regression Analysis using SPSS
    -   List all relevant output for a Linear Regression Analysis
    -   Define R, R squared and adjusted R squared
    -   Interpret R, R squared and adjusted R squared
    -   Write the mathematical equation for R squared and adjusted R squared.
    -   Relate ANOVA to Linear Regression Analysis
    ...
    -   Define B and the constant
    -   Explain in writing, the limits of Linear Regression Analysis
    -   Correctly and completely write up a Linear Regression Analysis
-   Power Analysis:
    -   Define Power and Effect Size
    -   List and define the components that influence power
    -   Define a power analysis
    -   Explain why a power analysis is run
    -   Explain the relationship between Power and Sample Size
    -   Define the "Law of diminishing returns"
    -   Explain the relationship between Power and Effect Size
    -   List and define the types of Power Analyses
    -   Explain how alpha and beta are set in a power analysis
    -   Identify the components needed to run a power analysis
    -   Identify and explain the methods for running a power analysis
    -   Explain how a researcher accounts for possible "lost data"
    -   Define the rules of 50, 16 and 15
    -   Show where to locate and how to use online sample size calculators
...
-   Analysis of variance learning objectives
    -   Know the conditions for use of an Independent One way ANOVA
    -   Know the conditions for use of a Repeated Measures ANOVA
    -   List and define the assumptions for an Independent One way ANOVA
    -   List and define the assumptions for a Repeated Measures ANOVA
    -   Run the assumptions for an Independent One way ANOVA
    -   Run the assumptions for a Repeated Measures ANOVA
    -   Interpret the output of the assumptions tests for an Independent One way ANOVA
    -   Interpret the output of the assumptions tests for a Repeated Measures ANOVA
    -   Run an Independent One way ANOVA using SPSS or SAS
    -   Run a Repeated Measures ANOVA using SPSS or SAS
    -   Interpret the output of an Independent One way ANOVA
    -   Interpret the output of a Repeated Measures ANOVA
    -   Calculate and interpret an effect size for an Independent One way ANOVA
    -   Calculate and interpret an effect size for a Repeated Measures ANOVA
    -   Understand the mathematical theory behind ANOVA
    -   Complete an ANOVA output table given partial information
    -   Calculate the Degrees of Freedom for an Independent One way ANOVA
    -   Calculate the Degrees of Freedom for a Repeated Measures ANOVA
    -   Relate Sums of Squares, Degrees of Freedom, Mean Square Error and the F-ratio
    -   Explain the relationship of power and type of ANOVA
    -   Relate effect size to power
-   Analysis of covariance learning objectives
