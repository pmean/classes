...
## Economic consequences of a bad diagnostic test

-   Newborn screening
    -   Expand to 29 diseases
    -   Early diagnosis can save lives
    -   But false positives are a problem
...
-   Screening for phenylketonuria (PKU)
    -   Inability to metaboloze phenylalanine
    -   Treatment is diet low in phenyalanine
    -   But significant harm from false positives
...
## Patient demand for diagnostic testing
...
-   Patient demands
    ...
    -   Electrocardiogram
-   Tests not needed
    -   Patient had hysterectomy
    -   Others not warranted in asymptomatic patients
