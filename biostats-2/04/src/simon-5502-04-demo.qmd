...
Boxes were used as tracking symbols in 70% of the trials with circles accounting for the remaining 30%..
...
Let's focus initially on the fourth trial. This is possibly a better indication of moter skills than the previous three trials, but that is a bit speculative on my part. The tracking task lasted for 15 seconds, so the average time is quite low. There is a wide range of variation, with one subject tracking for more than 11 seconds out of 15.
