...
:::notes
There are several ways to look at the data, and they all show that the vote for Buchannan in Palm Beach County was unusual. Here is a graph looking at the votes for Bush in each county of Florida on the X-axis and the votes for Buchanan in that same county.

Notice that there is a strong positive trend. Counties with lots of votes for Bush tended to produce lots of votes for Buchanan. Not one to one of course, because votes for Bush were in the hundreds of thousands, while votes for Buchanan were two orders of magnitude smaller.
...
Notice the one point very high in the middle of the graph. This is Palm Beach County. Buchanan got over 3,000 votes there and did not get anywhere close to that number in any other county.
:::
