...
In spite of the concerns with leverage and studentized residuals, none of these combine to create a serious concern about overly influential data. In other words, niether the outliers in the independent variables, nor the outliers in the residuals cause a very large shift in the regression line if they are removed.
