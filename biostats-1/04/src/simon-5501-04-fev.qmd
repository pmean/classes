...
The mean fev is 2.6 liters and the standard deviation is 0.84 liters. The fev values range from xx to xx. I am not an expert on pulmonary function, but these values appear to be reasonable.
