...
It is a bit silly to replace 1, 2, 3 with One, Two, Three. The main reason to use the factor function is to identify the variable shots as categorical rather than continuous.
