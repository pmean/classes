...
This program assesses the relationships among variables in a study of pulmonary function in children. There is a [data dictionary][dd] that provides more details about the data. The program was written by Steve Simon and Your Name on 2026-09-16 and is placed in the public domain.
...
Please include an interpretation here. 
...
```{r}
#| label: ht-fev-correlation

with(pulmonary, cor(ht, fev))
```
