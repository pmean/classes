...
![](../images/table-with-many-rows.png)
...
## Why is tall and thin better?

![](../images/nytimes-front-page.png)

::: notes
If your eye has to scan across long lines, you can easily loose track of where you are when you go from the end of one line to the beginning of another. That is why newspapers place most of their content in narrow columns.
