...
-   Surround any program chunk with four backticks

## Step 2

-   Surround the yaml header with four backticks

## Step 3

-   Find logical breaks in text
    -   blank line for yaml
    -   ## for qmd
    
## Step 4

-   Consolidate small chunks into bigger chunks

## Step 5

-   Put headers at the front of every chunk
    -   ## Listing of _filename_, sequence number
...
prefix_text <- rep("", length(yaml_text))
prefix_text[b[1]] <- 
    "\n\n## fruitfly.yaml, 1\n\n"
prefix_text[b[-1]] <- 
  paste0(
...
```{r}
#| output: asis
cat(yaml_chunks[1], sep="\n")
```

```{r}
#| output: asis
cat(yaml_chunks[2], sep="\n")
```
