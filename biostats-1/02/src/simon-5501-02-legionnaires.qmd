...
You can use "median(before)" in place of "quantile(before, probs=0.5)". You can also use "min(before)" and "max(before)" in place of "quantile(before, probs=0)" and "quantile(before, probs=1)".
