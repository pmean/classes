...
:::notes
While you might want to see information about all 31 columns of data, I can't display them all on a single slide. Here are the columns you need to work with in your programming assignment.
:::
