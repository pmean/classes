...
The [seq function][ref-seq], part of base R, calculates evenly spaced values within an interval. The code here calculates 100 evenly spaced values between -4 and +4 and dnorm to compute the bell curve at each point. Use geom_polygon to paint the area surrounded by the bell curve.
...
https://cran.r-project.org/web/packages/ggplot2/refman/ggplot2.html#ggplot

https://cran.r-project.org/web/packages/ggplot2/refman/ggplot2.html#aes

https://cran.r-project.org/web/packages/ggplot2/refman/ggplot2.html#geom_polygon
