...
The analysis of variance table is identical.
...
The intercept is the estimated average with both categories each to the "zero" level. In this case, the average lifespan of flies in a cage with one pregnant female.
