...
This module covers the following R functions

+ [cor](https://stat.ethz.ch/R-manual/R-patched/library/stats/html/cor.html)
+ dev.off
+ dim
+ geom_histogram
+ geom_point
...
+ V02-01. Rmarkdown structure
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=a2622a72-d29f-439a-bf45-ab61011c61ad).
  + The slides and speaker notes for this video can be found [here](http://www.pmean.com/introduction-to-r/results/v02-slides-and-speaker-notes.pdf).
+ V02-02. Outliers and missing values
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=a6dff7ac-7500-4a51-9fcd-ab610122d7e4).
  + See above for slides and speaker notes.
+ V02-03. Histograms
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8b88dd72-c299-4c4c-a067-ab61012884b9).
  + See above for slides and speaker notes.
+ V02-04. Correlations and scatterplots
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=3f2813a2-d934-4531-ad86-ab61012cec46).
+ V02-05. Description of sleep data
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=f4c09be7-bdf9-47b5-a506-ab61013219fc).
  + See above for slides and speaker notes.
...
+ General video. Good computing practices, part 1
  + Available in [Panopto format](https://umkc.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=55cf0d09-3647-4135-8354-ab1901530b60).
  + The slides and speaker notes for this video are not yet available.
...
### HW02. Draw graphs using the sleep data
...
I am including links to previous work for people who are curious, and to give me an opportunity to review and incorporate the best of each efforts.
