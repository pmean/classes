---
title: "Programming template for module 01"
format: 
  html:
...
This program serves as a model for your use in the programming assignment of 
module 01. It reads in data from a text file with comma delimiters, produces a 
few simple statistics and a simple graph.
...
The [library][ref01] function loads an R library. In this case, it loads the 
...
The [Sys.Date][ref02] function places a date-time stamp on your program. This 
helps you to determine if a particular set of output from R is in need of 
updating.

[R.version.string][ref03] is a scalar that is set by R before your program runs.
...
The message and warning options are two [execution options][ref04] that tell R
...
[ref01]: https://stat.ethz.ch/R-manual/R-devel/library/base/html/library.html
[ref02]: https://stat.ethz.ch/R-manual/R-devel/library/base/html/Sys.time.html
[ref03]: https://stat.ethz.ch/R-manual/R-devel/library/base/html/Version.html
[ref04]: https://quarto.org/docs/computations/execution-options.html
...
The [glimpse][ref05] function provides a listing of each variable in a data frame
...
[ref05]: https://dplyr.tidyverse.org/reference/glimpse.html
...
The [pipe][ref06] operator (|>) allows you to apply a series of functions in
...
The [summarize][ref07] function produces summary statistics for variables in your data.

[ref06]: https://stat.ethz.ch/R-manual/R-devel/library/base/html/pipeOp.html
[ref07]: https://dplyr.tidyverse.org/reference/summarise.html
...
[ggplot2][ref08] library. We will defer detailed discussion of this library 
until a later module.

[ref08]: https://ggplot2.tidyverse.org/
...
The [save][ref09] function is optional, but produces a binary file that you can use
...
[ref09]: https://stat.ethz.ch/R-manual/R-devel/library/base/html/save.html
