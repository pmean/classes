...
## Statistics involving missing values, 3
...
For methods that involve more than one variable, it gets trickier. Maybe you have data missing for just the first variable, just the second, or both.

:::

## Statistics involving missing values, 4
...
## Statistics involving missing values, 5
