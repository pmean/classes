...
If you want a format that is a bit closer to publication quality, the kable function (in the knitr package) is often a good start. I could spend a whole lecture on kable and other methods for printing nicely, but it is beyond the scope of this class.
