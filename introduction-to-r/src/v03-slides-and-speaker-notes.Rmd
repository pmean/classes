...
The readr package has several arguments that make your life easier, but the most important, when you are beginning is the col_types argument. if you specify col_types="n", that tells R to expect numbers (rather than strings or dates) for all of the columns that you input. You'll see in just a bit how to change this if some of your data is strings.
...
### Using the read_table function with delim="~"
