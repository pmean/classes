...
```{r ex1, echo=FALSE}
# Original source is https://stats.idre.ucla.edu/stat/data/binary.csv
fn <- "../data/binary.csv"
tx <- read_lines(fn)
cat(tx[1:6], sep="\n")
```
...
```{r read-tsa-3}
# Original source is https://dasl.datadescription.com/download/data/3061
...
```{r airport}
# Original source is http://jse.amstat.org/datasets/airport.dat.txt
fn <- "../data/airport.txt"
raw_data <- read_fwf(fn, 
