...
The [read_fwf][ref-read-fwf] function reads data from is described in the same page that describes the read_csv  and read_tsv functions. There is a similar function, [read.fwf][ref-read-dot-fwf], in the base R package that works similarly.
...
Peeking at the first ten lines of data, you can see that this file uses commas as delimiters and the first line contains variable names. 
